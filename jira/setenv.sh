...
export JAVA_OPTS="-javaagent:/atlassian-agent-jar-with-dependencies.jar ${JAVA_OPTS}"

# DO NOT remove the following line
# !INSTALLER SET JAVA_HOME

echo ""
echo "If you encounter issues starting or stopping Jira, please see the Troubleshooting guide at https://docs.atlassian.com/jira/jadm-docs-0817/Troubleshooting+installation"
echo ""
